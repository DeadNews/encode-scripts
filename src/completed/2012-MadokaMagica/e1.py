...
mrgc = dn.rfs_image(
    ...
    stabilize,
    "e1 164435",
    [(164435, 164467), (165147, 165561), (165864, 166020), (166631, 166768)],
)
...
mrgc = dn.rfs_hard(
    ...
    mrgc,
    mthr=2,
    maps=[(169404, 169679), (170118, 170189), (170220, 170480), (168853, 169295)],
)
...
F1 = dn.rfs(
    F1, F7, [(78538, 78897), (79127, 79162), (79235, 79279), (80462, 80485), (80639, 80656)]
)
F1 = dn.rfs(
    F1,
    F8,
