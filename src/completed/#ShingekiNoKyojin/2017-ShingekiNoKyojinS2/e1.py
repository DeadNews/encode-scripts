...
usa = dn.source(f"./in/usa/{epname}.mp4")[24:].std.DeleteFrames([21147, 34166])  # e1
# ------------ #
...
"""
2: 9590 13622 15350 68548 68786
"""
# epis.set_output()
# dn.rfs_resc(epis=epis, mthr=65, out_mask=True).set_output()
# dn.rfs_diff(epis, jpn, mthr=2, out_mask=True).set_output()
# ------------ #
