...
if __name__ == "__main__":
    ...
    for epname in safe_load(chapters):
        try:
            ...
            zone = f"{epname}: {OP},{OPend-1},b=0.76/{OPend},{OPend+120},b=0.36/{ED},{EDend-1},b=0.35/{Next},{T1},b=0.36/{T2},{EOF-1},b=0.36"
            print(zone)
            ...
            zone = (
                f"{epname}: {OP},{OPend-1},b=0.76/{OPend},{OPend+120},b=0.36/{ED},{EDend-1},b=0.35"
            )
            print(zone)
