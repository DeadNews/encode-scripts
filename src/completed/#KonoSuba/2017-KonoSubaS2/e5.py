...
"""
db 53410 101410 56770
---8
aa 106821 118541 120461 227285 12533
db 202821 106821 113541
"""
# epis.set_output()
# epis.std.Trim(ED, ED+179).set_output()
# clip.std.Trim(36034, 36213).set_output()
# clip.std.Trim(8310, 8750).set_output()
# ------------ #
