...
F1 = dn.rfs(F1, F6, [(4490, 4789), (8197, 8514)])  # same as e16
F1 = dn.rfs(F1, F4, [(5302, 5911)])  # same as avant op
# ------------ #
...
"""
2: 14560 16000 16576 11392 9376
"""
# epis.set_output()
# dn.rfs_resc(epis=epis, mthr=148, out_mask=True).set_output()
# clip.std.Trim(4490, 4789).set_output()
# ------------ #
