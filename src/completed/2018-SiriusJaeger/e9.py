...
ed = dn.oped(epis_back, name="ed", offset=252, start=ED, end=EDend)
...
mrgc = dn.rfs_resc(mrgc, epis, mthr=150, maps="[30782 30951]", zone="resc_fix")  # PreED
# ------------ #
...
# dn.rfs_resc(epis=epis, mthr=150, out_db_mode=True, zone='resc_fix').set_output()
# ------------ #
