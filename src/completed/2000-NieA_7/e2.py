...
epis = dn.rfs(
    epis,
    epis_back,
    f"[{ED} {epis.num_frames-1}] [{OP} {OPend-1}] [2692 2751] [3003 3110] [9727 10032] [15549 15604] [18161 18193] [21746 21780] [25670 25801] [30852 30971]",
)
epis = dn.rfs(epis, fix, "[18038 18131] [25502 25669] [27333 27440] [28312 28479]")
# ------------ #
