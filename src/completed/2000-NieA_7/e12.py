...
epis = dn.rfs(
    epis,
    epis_back,
    f"[{ED} {epis.num_frames-1}] [{OP} {OPend-1}] [2927 3056] [10779 10866] [11746 12663] [12664 12784] [17758 17918]",
)
...
"""
# epis.set_output()
# clip.resize.Spline36(960, 720).std.Trim(11746, 12663).set_output()
