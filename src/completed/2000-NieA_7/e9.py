...
epis = dn.rfs(
    epis,
    epis_back,
    f"[{ED} {epis.num_frames-1}] [{OP} {OPend-1}] [4651 4689] [5216 5359] [9919 9982] [22464 22650] [26812 27318] [28235 28325]",
)
epis = dn.rfs(epis, fix, "[8348 8644] [11142 11236] [17941 18132] [19837 19881] [30463 30606]")
# ------------ #
