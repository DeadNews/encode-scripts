...
op = dn.oped(epis, name="op1", offset=30, start=OP, end=OPend, desc_h=desc_h, kernel=kernel)
ed = dn.oped(epis, name="ed2", offset=24, start=ED, end=EDend, desc_h=desc_h, kernel=kernel)
