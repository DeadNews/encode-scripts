...
EDend = dn.chapt(epname, "Next", "Part_C")
...
mrgc = dn.rfs_resc(mrgc, epis, mthr=70, maps="[14396 14665] [26546 26688]")  # randon signs
# ------------ #
...
"""
# epis.set_output()
# r1 = dn.rfs_resc(epis=epis, mthr=70, out_mask=True)
# r2 = dn.rfs_resc(epis=epis, mthr=20, out_db_mode=True, ver2=True)
# r3 = dn.rfs_resc(epis=epis, mthr=168, out_db_mode=True, zone='resc')
# core.std.Interleave([r1, r3]).set_output()
