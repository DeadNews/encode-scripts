...
"""
2: 24644 5242 50236 11890 29857 5292 12864 4930 6532 9700
6: 101014 14674 6532 9124 75376 199372 176056 194050 191290
1: 2646 25133
"""
# epis.set_output()
# dn.rfs_resc(epis=epis, mthr=70, out_mask=True).set_output()
# dn.rfs_resc(epis=epis, mthr=40, out_db_mode=True, v2=True).set_output()
# dn.rfs_resc(epis=epis, mthr=40, out_db_mode=True, zone='resc').set_output()
# ------------ #
