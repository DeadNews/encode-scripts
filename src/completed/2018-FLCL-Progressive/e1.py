...
F1 = dn.rfs(F10, F0, [(end, epis.num_frames - 1)])
...
F1 = dn.rfs(
    F1, F19, [(88326, 88332), (88628, 88680), (89149, 89279), (92988, 93028), (159297, 159498)]
)
F1 = dn.rfs(F1, F01, [(113140, 113198)])
#
F1 = dn.rfs(F1, F20, [(126106, ep6 - 1)])
...
F1 = dn.rfs(
    F1,
    F24,
    [(143359, 143777), (143847, 143970), (144603, 144685), (144885, 145448), (145521, 145620)],
)
# ------------ #
