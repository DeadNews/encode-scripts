...
if __name__ == "__main__":
    ...
    for epname in safe_load(chapters):
        try:
            ...
            zone = f"{epname}: {OP},{OP+1412},b=0.49/{OP+1413},{OPend-1},b=0.99/{ED},{ED+1352},b=0.49/{ED+1353},{ED+1451},b=0.99/{ED+1452},{ED+1760},b=0.49/{ED+1761},{ED+1864},b=0.99/{ED+1865},,b=0.49"
